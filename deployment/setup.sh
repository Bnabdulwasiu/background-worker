...
# Add NodeSource official repository for Node.js v20
...
apt-get install -y python3-pip python3-venv nginx postgresql postgresql-contrib git certbot python3-certbot-nginx nodejs rsync
